...
public:
	...
	static void		updateFsyncDisable(MYSQL_THD thd, struct st_mysql_sys_var* variable, void *var_ptr, const void *save);
	static void		updateConsistentRead(MYSQL_THD thd, struct st_mysql_sys_var* variable, void *var_ptr, const void *save);
