...
MemoryResultSetColumn::MemoryResultSetColumn(const char *columnName, const char *columnLabel, int columnType, int columnDisplaySize, int columnPrecision, int columnScale)
{
	name = columnName;
	label = columnLabel;
